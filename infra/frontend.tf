# Static React frontend: private S3 bucket served through CloudFront.
# CloudFront is global, so the frontend needs no active-dormant story —
# it stays up even during a regional backend failover.
